...
const WorkingAboutSection = () => {
    console.log('🚀 WorkingAboutSection: Component rendering...');
    
    const { language } = useLanguage();
    console.log('📍 WorkingAboutSection: Current language =', language);
    
    const t = translations[language];
    console.log('📝 WorkingAboutSection: Translation object =', t);
...
export default WorkingAboutSection;
